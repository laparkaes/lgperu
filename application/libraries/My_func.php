...
class My_func{
	...
	public function load_exchange_rate_sbs($date = null, $code = "02"){
		...
		$token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..QMnbHYFKQYmTXPvzWVsEmVU9HXnqiUo5yIiVVud4dpM';
	...
	public function get_gerp_iod($from, $to, $org = "N4E"){
		//set db fields
		...
		$w_g = ["inventory_org" => $org, "create_date >=" => $from, "create_date <=" => $to, "line_status !=" => "Cancelled", "customer_department !=" => "Branch"];
		...
		$w_g_ = ["inventory_org" => $org, "create_date <" => $from, "close_date >=" => $from, "close_date <=" => $to, "line_status !=" => "Cancelled", "customer_department !=" => "Branch"];
		...
		$w_g__ = ["inventory_org" => $org, "create_date <" => $from, "line_status !=" => "Cancelled", "customer_department !=" => "Branch"];
