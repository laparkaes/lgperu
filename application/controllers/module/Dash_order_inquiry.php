...
class Dash_order_inquiry extends CI_Controller {
	...
	public function upload(){
		...
		if ($this->upload->do_upload('attach')){
			$type = "success";
			$url = base_url()."module/dash_order_inquiry/process_file";
	...
	public function process_file(){
		...
		if ($is_closed_order){
			...
			for($i = 2; $i < $max_row; $i++){
				...
				//print_r($coi); echo "<br/><br/>"; print_r($row); echo "<br/><br/>";
			}
		}elseif($is_sales_order){
		...
		}else echo "Wrong file.<br/><br/>";

		if ($qty_insert > 0) echo number_format($qty_insert)." inserted<br/><br/>";
		if ($qty_update > 0) echo number_format($qty_update)." updated<br/><br/>";
		if ($qty_fail > 0) echo number_format($qty_fail)." failed<br/><br/>";
		echo "===================================================<br/><br/>Finished. You can close this tab.<br/><br/>";
	}
}
