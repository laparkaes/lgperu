...
class File_folder extends CI_Controller {
	...
	public function upload(){
		...
		else $this->session->set_flashdata('danger_msg', str_replace("p>", "div>", $this->upload->display_errors()));
	...
	public function del($f){
		...
		if (file_exists($file_path)) {
            ...
            else $this->session->set_flashdata('danger_msg', 'Failed.');
        }else $this->session->set_flashdata('danger_msg', 'File no exists.');
