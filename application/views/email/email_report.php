...
<body>
    ...
    <div class="email-container">
        <div class="header">
            ...
            <h1>Reporte Asistencia Diaria</h1>
        </div>

        <div class="content">
            <!--<p>Estimado/a <?= $info_pr['name']?>,</p>-->
			
			<!--<p>Informamos que el dia de hoy <?= $current_day_format?> no ha registrado su asistencia. </p>-->
			
			<p>Envio reporte de asistencia del dia <?=$current_day_format?>. 
            <p>A continuacion, se detalla la informacion:</p>
                ...
                <table class="table-container">
                    ...
                    <tbody>
                        <?php foreach ($info as $info_pr): ?>
                            <tr>
                                <td><?= $current_day ?></td>
                                <td><?= $info_pr[0]['name'] ?></td>
								<td><?= $info_pr[0]['pr'] ?></td>
                                <td><?= $info_pr[0]['work_start'] ?></td>
                                <td><?= $info_pr[0]['first_access'] ?></td>								
								<td><?= $delay[$info_pr[0]['pr']] ?></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
