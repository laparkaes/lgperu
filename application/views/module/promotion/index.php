		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-body">
					...
					<div class="row">
						<div class="col-md-6">
							<form class="row g-3" id="form_add_promotion">
								<div class="col-md-6">
									<label class="form-label">Customer</label>
									<input type="hidden" class="form-control" name="customer_id">
									<div class="input-group">
										<input type="text" class="form-control" id="inp_customer">
										<button class="btn btn-primary" id="btn_search_customer" type="button">Search</button>
									</div>
								</div>
								<div class="col-md-3">
								...
								<div class="col-md-6">
									...
									<div class="input-group">
										...
										<button class="btn btn-primary" id="btn_search_product" type="button">Search</button>
									</div>
								</div>
								<div class="col-md-6">
						...
						<div class="col-md-6">
							<div class="mb-3" id="info_promotion"></div>
							<div class="mb-3" id="info_customer"></div>
