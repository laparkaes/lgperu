				...
				<div class="card-body">
					...
					<form class="row g-3" id="form_new_activity">
						...
						<div class="col-md-2">
							...
							<input class="form-control" name="approval">
						</div>
						<div class="col-md-2">
						...
						<div class="col-md-2">
							...
							<?php $list = ["En proceso", "Finalizado", "Cancelado"]; ?>
...
document.addEventListener("DOMContentLoaded", () => {
	$("#form_new_activity").submit(function(e) {
		...
		ajax_form_warning(this, "module/ism_activity_management/add_activity", "Do you add new activity?").done(function(res) {
