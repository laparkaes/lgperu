						...
						<div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
							<div class="d-flex justify-content-center py-4">
								<a href="<?= base_url() ?>" class="logo d-flex align-items-center w-auto">
									...
									<span class="d-none d-lg-block">LlamaSys by LGEPR</span>
								</a>
							</div><!-- End Logo -->
							<div class="card mb-3">
								<div class="card-body">
									...
									<form class="row g-3" id="form_login">
										<div class="col-12">
											<label for="yourUsername" class="form-label">EP Mail</label>
											<div class="input-group mb-3">
												<input type="text" class="form-control" name="ep_mail" required>
												<span class="input-group-text">@lge.com</span>
											</div>
										</div>
										<div class="col-12">
	...
	document.addEventListener("DOMContentLoaded", () => {
		$("#form_login input").keydown(function(event) {
			if (event.keyCode === 13) { // 13 is the key code for Enter
				...
				$("#form_login").submit(); // Submit the form
			}
		});
