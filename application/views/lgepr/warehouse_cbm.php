			...
			<div class="card-body py-0">
				<div class="d-flex justify-content-between align-items-center">
					<div class="d-flex justify-content-start align-items-center">
						...
						<h5 class="card-title py-3 my-0">Warehouse CBM Simulation from <?= $from ?> to <?= $to ?></h5>
					</div>
					<div class="d-flex justify-content-end align-items-center">
						<span class="badge bg-light text-dark me-1 fs-6">Updated at:</span>
						<span class="badge bg-light text-dark me-1 fs-6">[Arrivals] <?= $updated_at_arrival ?></span>
						<span class="badge bg-light text-dark me-3 fs-6">[Sales] <?= $updated_at_sales ?></span>
						...
						<table class="table table-sm table-bordered">
							...
							<tbody class="table-group-divider">
								<tr>
									<td>
										<div>Total</div>
										<div><small class="text-danger">Arrivals</small></div>
