<div class="d-flex justify-content-between align-items-start">
	<div class="pagetitle">
		<h1>Merge for ESPR</h1>
		<nav>
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="<?= base_url() ?>dashboard">Dashboard</a></li>
				<li class="breadcrumb-item active">Merge for ESPR</li>
			</ol>
		</nav>
	</div>
	<div></div>
...
document.addEventListener("DOMContentLoaded", () => {
	$("#form_merge_order_inquiry").submit(function(e) {
		...
		ajax_form_warning(this, "dashboard/espr_merge_order_inquiry", "Do you want to generate ESPR template file?").done(function(res) {
